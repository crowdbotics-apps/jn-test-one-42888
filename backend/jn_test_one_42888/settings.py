"""
Django settings for jn_test_one_42888 project.
...
ROOT_URLCONF = 'jn_test_one_42888.urls'
...
WSGI_APPLICATION = 'jn_test_one_42888.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jn_test_one_42888 API",
    "DESCRIPTION": "API documentation for jn_test_one_42888 App",
    "VERSION": "v1",
}
